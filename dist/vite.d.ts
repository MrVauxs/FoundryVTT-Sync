 ...
 */
export default function foundryvttSyncVite(moduleJSON: {
    id: string;
}, options?: Parameters<typeof createPlugin>[1]): (options?: unknown) => import("vite").Plugin<any> | import("vite").Plugin<any>[];
