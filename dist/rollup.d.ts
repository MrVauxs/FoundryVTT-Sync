 ...
 */
export default function foundryvttSyncRollup(moduleJSON: {
    id: string;
}, options?: Parameters<typeof createPlugin>[1]): (options?: unknown) => import("rollup").Plugin<any> | import("rollup").Plugin<any>[];
